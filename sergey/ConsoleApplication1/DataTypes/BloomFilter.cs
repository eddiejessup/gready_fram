// Source: https://gist.github.com/richardkundl/8300092
...
namespace ConsoleApplication1.DataTypes
{
	...
	public class BloomFilter<T>
	{
		...
		public void Add(T item)
		{
			...
			var primaryHash = (ulong)item.GetHashCode();
			var secondaryHash = (ulong)_getHashSecondary(item);
			for (var i = 0ul; i < _hashFunctionCount; i++)
			{
